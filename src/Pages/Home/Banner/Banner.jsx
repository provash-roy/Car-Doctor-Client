  ...
  return (
    <div className="carousel w-full h-[500px]">
      <div id="slide1" className="carousel-item relative w-full">
        ...
        <div className="absolute rounded-2xl bg-black/50 inset-0 flex items-center pl-20">
      ...
      <div id="slide3" className="carousel-item relative w-full">
        ...
        <div className="absolute rounded-2xl left-5 right-5 bottom-0 flex -translate-y-1/2 transform justify-end">
